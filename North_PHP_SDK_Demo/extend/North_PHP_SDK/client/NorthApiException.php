...
class NorthApiException extends \Exception{
    ...
    public function __toString(){
        return "NorthApiException [error_code=" . $this->error_code . ", error_desc=" .
        $this->error_desc . ", httpStatusCode=" . $this->httpStatusCode .
         ", httpReasonPhase=" . $this->httpReasonPhase . ", httpMessage=" .
         json_encode($this->httpMessage) . "]";
    }
}